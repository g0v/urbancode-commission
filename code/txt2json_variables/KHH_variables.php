...
$sectionPack->report_item = '報告案件';
$sectionPack->confirm_item = '確認案件';
$sectionPack->deliberate_item = '審議案件';
$sectionPack->dicuss_item = '(研議|討論)案件';
